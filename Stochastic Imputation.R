...
simulation <- function(a) 
{
  ...
  tibble(
    ...
    sto_imp_var = stoch_imp(data)$se^2,
    bootstrap_var = bootstrap_var(data, B = 100)$var,
...
plot(df_fnl$prob_f, df_fnl$true_var, col="black", pch="o", xlab="Probability of missing X with Z = 1", ylab=expression(paste(hat(beta[1]), " variance")), lty=1)
...
legend(0.01,0.019,legend=c("True Variance","Deterministic Imputation","Stochastic Imputation","Bootstrap","Complete Case"), col=c("black","orange","skyblue","#009E73","#CC79A7"),
